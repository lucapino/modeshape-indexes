 ...
 */
package com.github.lucapino.modeshape.indexes.local;
 ...
 */
@Test
public class ModeshapeLocalIndexesTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(ModeshapeLocalIndexesTest.class);
    ...
    public void start() {
        ...
        FileUtil.delete("target/repoLocal");
    }
    ...
    private void startEngineAndRepository() throws Exception {
        ...
        URL url = this.getClass().getClassLoader().getResource("repositoryLocal.json");
